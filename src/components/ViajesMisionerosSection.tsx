...
import oaxacaImage from "@/assets/oaxaca.jpg";
  ...
  return (
    <section className="relative">
      ...
      <div className="relative h-[50vh] md:h-[60vh]">
        <img
          src={prayerImage}
          alt="Viajes Misioneros"
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-black/50" />
        <div className="absolute inset-0 flex items-center justify-center">
          <h2 className="text-white text-4xl md:text-6xl lg:text-7xl font-serif italic text-center">
      ...
      <div className="bg-background px-5 md:px-20 py-16">
        <h3 className="heading-lg text-primary font-serif italic text-center mb-12">
          Viajes Misioneros 2026
        </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="relative rounded-2xl overflow-hidden group cursor-pointer card-hover">
            <img
              src={oaxacaImage}
              alt="La sierra de Oaxaca, México"
              className="w-full h-[300px] md:h-[350px] object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent" />
            <div className="absolute bottom-6 left-6 right-6">
              <p className="text-white/80 text-sm mb-1">La sierra de</p>
              <h4 className="text-white text-2xl md:text-3xl font-serif italic">
                Oaxaca, México
              </h4>
            </div>
          </div>
