    ...
    <section className="relative">
      ...
      <div className="relative h-[50vh] md:h-[60vh]">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <h2 className="text-white text-4xl md:text-6xl lg:text-7xl font-serif italic text-center">Viajes Misioneros 2026</h2>
        </div>
      </div>
      ...
      <div className="bg-background px-5 md:px-20 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="relative rounded-2xl overflow-hidden group cursor-pointer card-hover">
            <img src="/assets/oaxaca.jpg" alt="La sierra de Oaxaca, México" className="w-full h-[300px] md:h-[350px] object-cover" />
          ...
          {/* Kenya Card */}
          <div className="relative rounded-2xl overflow-hidden group cursor-pointer card-hover">
            <img src="/assets/kenya.jpg" alt="Kenya, Africa" className="w-full h-[300px] md:h-[350px] object-cover" />
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent" />
            <div className="absolute bottom-6 left-6 right-6">
