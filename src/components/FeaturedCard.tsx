      ...
      <article className={cn("card-hover rounded-3xl overflow-hidden", colorClass)}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
          ...
          <div className="p-8 md:p-12 flex flex-col justify-center order-2 md:order-1">
            <time className="text-sm md:text-base font-medium text-foreground/70 mb-4 block font-sans">{date}</time>
            <h2 className="text-5xl leading-[0.8] md:text-7xl mb-4 font-sans font-extrabold tracking-tighter">{title}</h2>
            <p className="text-base md:text-lg leading-relaxed text-foreground/80 mb-6 font-serif">{excerpt}</p>
