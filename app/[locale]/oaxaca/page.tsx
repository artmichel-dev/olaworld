...
export async function generateMetadata({
  ...
  return {
    ...
    description: oaxaca.description1 as string,
    keywords: ["Oaxaca", "Mexico", "mission trip", "indigenous", "mountains", "evangelism"],
    openGraph: {
      title: `${oaxaca.title} - OLA World`,
      description: oaxaca.description1 as string,
        ...
        <section className="bg-card-cream">
          ...
          <div className="px-5 md:px-20 pb-16">
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <div>
                <h4 className="text-primary font-semibold mb-3 underline">
                  {(t.whatToExpect as Record<string, string>).title}
                </h4>
                <p className="text-foreground/80 text-sm md:text-base leading-relaxed">
                  {(t.whatToExpect as Record<string, string>).content}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-foreground/80 text-sm md:text-base leading-relaxed mb-4">
                  <strong>{(t.cost as Record<string, unknown>).amount as string}</strong> - {(t.cost as Record<string, unknown>).details as string}
                </p>
                <p className="text-foreground/80 text-sm md:text-base leading-relaxed">
